 ...
 * @author dirk.mahler
 */
public class OpenWebBeansSEContainer extends Container {

	private static final Logger LOGGER = LoggerFactory
			.getLogger(OpenWebBeansSEContainer.class);

	/**
	 * The {@link OpenWebBeansSEContainer} is a singleton instance.
	 */
	private static final OpenWebBeansSEContainer INSTANCE = new OpenWebBeansSEContainer();
	 ...
	 * Private constructor.
	 */
	private OpenWebBeansSEContainer() {
	}
	 ...
	 */
	public static OpenWebBeansSEContainer getInstance() {
		return INSTANCE;
	}
