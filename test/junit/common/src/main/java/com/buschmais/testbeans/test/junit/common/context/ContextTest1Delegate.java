 ...
 * @author dirk.mahler
 */
public class ContextTest1Delegate extends AbstractContextTestDelegate {

	public ContextTest1Delegate(Container container) {
		super(container);
	}

	public void beforeConcreteClass() {
	...
	public void afterConcreteClass() {
		checkPayload(SuiteScopedBean.class, "default");
		checkPayload(ClassScopedBean.class, "class");
		checkUnexpectedBean(MethodScopedBean.class);
	}
