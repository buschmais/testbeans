 ...
 */
package com.buschmais.testbeans.test.junit.weldse.methodrule.event;
...
import com.buschmais.testbeans.test.junit.weldse.methodrule.AbstractWeldSEMethodRuleTest;
 ...
 * @author dirk.mahler
 */
public class Events extends AbstractWeldSEMethodRuleTest {
	...
	public static void beforeClass() {
		activateClassContext(Events.class);
	...
	public static void afterClass() {
		delegate.afterClass();
		deactivateClassContext(Events.class);
	}
