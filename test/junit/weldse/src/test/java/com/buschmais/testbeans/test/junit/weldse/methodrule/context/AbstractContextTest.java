 ...
 * @author dirk.mahler
 */
public abstract class AbstractContextTest extends AbstractWeldSEMethodRuleTest {
	...
	public static void beforeAbstractClass() {
		activateClassContext(AbstractContextTest.class);
	...
	public static void afterAbstractClass() {
		...
		deactivateClassContext(AbstractContextTest.class);
	}
